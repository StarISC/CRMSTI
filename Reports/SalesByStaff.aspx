<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesByStaff.aspx.cs" Inherits="SalesByStaff" MasterPageFile="~/Site.Master" %>
<asp:Content ID="TitleContent" ContentPlaceHolderID="TitleContent" runat="server">Báo cáo - Theo nhân viên bán hàng</asp:Content>
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        #salesByStaffTable_wrapper .dataTables_length { display: none; }
    </style>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card shadow-sm report-card mb-3">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h4 mb-1 text-primary">Báo cáo theo nhân viên bán hàng</h2>
                    <div class="text-muted">Tổng hợp booking theo người tạo trong khoảng thời gian</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-3">
            <div class="card shadow-sm report-card">
                <div class="card-body">
                    <div class="kpi" id="kpiStaff">0</div>
    ...
    <div class="card shadow-sm report-card mb-3">
        <div class="card-body">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold">Từ khóa nhân viên</label>
                    <input type="text" id="staffKeyword" class="form-control" placeholder="Tên hoặc username" />
                </div>
    ...
    <div class="card shadow-sm report-card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="salesByStaffTable" class="table table-striped table-hover align-middle mb-0" style="width:100%">
    ...
    <script>
        $(function () {
            ...
            var table = $('#salesByStaffTable').DataTable({
                processing: true,
                serverSide: true,
                searching: false,
                ajax: {
                    url: 'SalesByStaffApi.aspx',
                    type: 'POST',
                    data: function (d) {
                        d.fromDate = $('#fromDate').val();
                        d.toDate = $('#toDate').val();
                        d.keyword = $('#staffKeyword').val();
                    }
                },
                pageLength: 50,
                columns: [
        ...
        function loadSummary() {
            $.getJSON('SalesByStaffSummaryApi.aspx', {
                fromDate: $('#fromDate').val(),
                toDate: $('#toDate').val(),
                keyword: $('#staffKeyword').val()
            }, function (resp) {
                if (!resp || resp.error) return;
                $('#kpiStaff').text(formatNumber(resp.TotalStaff));
