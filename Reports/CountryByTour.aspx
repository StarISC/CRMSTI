<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CountryByTour.aspx.cs" Inherits="CountryByTour" MasterPageFile="~/Site.Master" %>
<asp:Content ID="TitleContent" ContentPlaceHolderID="TitleContent" runat="server">Báo cáo - Theo quốc gia</asp:Content>
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        #countryByTourTable_wrapper .dataTables_length { display: none; }
    </style>
</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card shadow-sm report-card mb-3">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="h4 mb-1 text-primary">Báo cáo theo quốc gia</h2>
                    <div class="text-muted">Tổng hợp booking theo quốc gia trong khoảng thời gian</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-3">
            <div class="card shadow-sm report-card">
                <div class="card-body">
                    <div class="kpi" id="kpiCountries">0</div>
                    <div class="kpi-label">Quốc gia</div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="card shadow-sm report-card mb-3">
        <div class="card-body">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label fw-semibold">Từ khóa quốc gia</label>
                    <input type="text" id="countryKeyword" class="form-control" placeholder="Quốc gia" />
                </div>
    ...
    <div class="card shadow-sm report-card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="countryByTourTable" class="table table-striped table-hover align-middle mb-0" style="width:100%">
    ...
    <script>
        $(function () {
            ...
            var table = $('#countryByTourTable').DataTable({
                processing: true,
                serverSide: true,
                searching: false,
                ajax: {
                    url: 'CountryByTourApi.aspx',
                    type: 'POST',
                    data: function (d) {
        ...
        function loadSummary() {
            $.getJSON('CountryByTourSummaryApi.aspx', {
                fromDate: $('#fromDate').val(),
                toDate: $('#toDate').val(),
                keyword: $('#countryKeyword').val()
            }, function (resp) {
                if (!resp || resp.error) return;
                $('#kpiCountries').text(formatNumber(resp.TotalCountries));
